...
public class Config {
    ...
    // new city
    public static String newCityRoot = "./../new_data/city/";
    public static String newCityGraph = newCityRoot + "graph.txt";
    public static String newCityVertex = newCityRoot + "vertex.txt";
    public static String newCityEdge = newCityRoot + "edge.txt";
